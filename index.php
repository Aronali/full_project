                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="design.php">Designs <span class="sr-only"></span></a> </li>
						...
						?>
						            <li class="nav-item"> <a class="nav-link active" href="http://localhost/Techknow%20Graphics/admin/">Admin Login <span class="sr-only"></span></a> </li>
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            <svg viewbox="0 0 483 483" width="512" height="512">
                                
                            </svg>
                            <h4><span style="color:white;">1. </span>Choose your design</h4> </div>
                
                        <div class="step-item step2">
                            <svg  width="512" height="512" viewbox="0 0 380.721 380.721">
                                
                            </svg>
                            <h4><span style="color:white;">2. </span>Order design</h4> </div>
              
                        <div class="step-item step3">
                            <svg width="512" height="512" viewbox="0 0 612.001 612">
                            </svg>
                            <h4><span style="color:white;">3. </span>We Design,print and deliver.</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Creating impactful visuals that speak volumes using your designs.</p>
                </div>
                <div class="row">
						<?php 					
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a design sample</h3>
                                    <p>At TechKnow Graphic Design, we redefine visual storytelling by merging cutting-edge technology with boundless creativity</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a type.</h3>
                                <p>Our team pioneers innovative design solutions that transcend the ordinary, crafting immersive experiences that resonate with your audience</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>We design, print and deliver.</h3>
                                <p>With TechKnow, your vision becomes our canvas, where innovation meets design excellence. </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Mpesa (till payment) or cash payment is accepted</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured Design Samples</h4> </div>
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Litein, Nairobi</p>
                                    <h5>Phone: 0745043388</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Designing beyond boundaries: Where imagination meets innovation.
                                   Each design is not just an image but a carefully orchestrated composition, 
                                   speaking volumes in a single glance.
                                   </p>
                                </div>
                    </div>
                </div>
